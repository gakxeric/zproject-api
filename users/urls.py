...
from .views import UserListViewset, UserDetailViewset, AuthenticationViewset, VerificationsViewset,check_status
...
urlpatterns = [
    ...
    path('check-status/<slug:pk>', check_status, name="user-details"),
]